({
    doInit : function(component, event, helper) {
        ...
        inputVariables.push({ name : 'ProcessType', type : 'String', value : 'Posizionamento contenitore' });
        inputVariables.push({ name : 'RecordTypeName', type : 'String', value : 'HDT_RT_PosizionamentoContenitore' });

    ...
    doInit : function(component, event, helper) {
        ...
        if(caseId === null || caseId === 'undefined' || caseId === undefined){
            ...
            if(processType === 'Annullamento prestazione' || processType === 'Annullamento segnalazioni' || processType === 'Ripristina fase' || processType === 'Ripensamento'
                ...
                || processType ==='Annullamento rimborso tari' || processType ==='Annullamento contratti TARI' || processType ==='Annullamento prestazione tari' || processType === 'Sospensione' || processType === 'Chiusura' || processType === 'Associa Dotazioni'){

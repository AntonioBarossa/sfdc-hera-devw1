      ...
      //  console.log('# component set recordid -> '+component.get("v.recordid"))
       ...
       /* workspaceAPI.getEnclosingTabId().then(function(tabId) {
        ...
        if(caseId === null || caseId === 'undefined' || caseId === undefined){
            ...
            || processType ==='Annullamento errore fatturazione' || processType ==='Annullamento rimborso tari' || processType ==='Annullamento contratti TARI' || processType ==='Annullamento prestazione tari' || processType ==='Associa Dotazioni'){
                inputVariables.push({ name : 'ProcessType', type : 'String', value : processType });
            }

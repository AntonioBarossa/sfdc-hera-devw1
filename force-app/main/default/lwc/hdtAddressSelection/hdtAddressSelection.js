...
export default class HdtAddressSelection extends LightningElement {
    @api searchLabel;
    @api searchVariant;
        ...
        getConfiguration({
            ...
            .then(result => {
                ...
                if(Object.keys(wiredResponse).length > 0){
                    ...
                    var params = '{"filters": "'+ filters +'","soslSearchTerm":"'+wiredResponse[0].Default_Search_Key__c +'", "objectName":"'+wiredResponse[0].sObject__c +'", "fields":"'+wiredResponse[0].Fields__c + '", "distinct":"'+ wiredResponse[0].Distinct__c+'"}';
    ...
    handleNext(event){
        if(this.results != null && this.results != "" && this.results != "undefined"){
            ...
            this.showMessage('Errore','Attenzione! Seleziona un Indirizzo prima di andare avanti','error');  

        ...
        this.fields = [
            {
                ...
                data:[
                    ...
                    new fieldData('Sottocategoria Ronchi','RonchiSubcat__c', !["HDT_RT_AgevolazioniAmbiente", "HDT_RT_ModificaTariffaRimozione"].includes(this.order.RecordType.DeveloperName), this.order.RateCategory__c=='TATND00001', galse,'',''),
            ...
            },
            {
               ...
               data: [
                ...
                new fieldData('Esclusione dal deposito cauzionale','SecurityDepositExcluded__c', this.typeVisibility('both') && this.rateCategoryVisibility(rateCategories.DEP_CAUZ_ESCL) && (this.order.RecordType.DeveloperName === 'HDT_RT_Subentro' || this.order.RecordType.DeveloperName === 'HDT_RT_SwitchIn' || this.order.RecordType.DeveloperName === 'HDT_RT_AttivazioneConModifica' || this.order.RecordType.DeveloperName === 'HDT_RT_CambioOfferta'), this.rateCategoryVisibility(rateCategories.DEP_CAUZ_ESCLreq), false, '','N'),
                ...
                new fieldData('Consumi Anno','AnnualConsumption__c', this.typeVisibility('both') && this.rateCategoryVisibility(rateCategories.AQCNSANNOF), this.rateCategoryVisibility(rateCategories.AQCNSANNOFreq), true, '',''),

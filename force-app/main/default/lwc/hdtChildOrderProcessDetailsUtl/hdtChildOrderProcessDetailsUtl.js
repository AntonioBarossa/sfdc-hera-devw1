        ...
        this.fields = [
            ...
            },
            {
               ...
               data: [
                ...
                new fieldData('','NotDisconnectabilityCustomer__c', this.typeVisibility('both') && rateCategoryVisibility(rateCategories.AF_NODISAL), false, false, '',''),
                ...
                new fieldData('','QuotationType__c', this.typeVisibility('acqua') && this.order.RecordType.DeveloperName === 'HDT_RT_ConnessioneConAttivazione', false, true, '',''),

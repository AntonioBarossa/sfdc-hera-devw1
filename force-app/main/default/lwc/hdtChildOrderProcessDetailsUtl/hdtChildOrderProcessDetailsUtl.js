        ...
        this.fields = [
            ...
            },
            {
               ...
               data: [
                ...
                new fieldData('','ResidentDomesticHousingUnit__c', this.typeVisibility('both') && this.rateCategoryVisibility(rateCategories.AFUADRS), false, true, '','1'),
                new fieldData('','NotDomesticHousingUnit__c', 
                    this.typeVisibility('both') && !(this.order.RecordType.DeveloperName === 'HDT_RT_Subentro') && !(this.order.RecordType.DeveloperName === 'HDT_RT_CambioOfferta') && ( this.rateCategoryVisibility(rateCategories.AFUND) || this.rateCategoryVisibility(rateCategories.AFUNDA) || 

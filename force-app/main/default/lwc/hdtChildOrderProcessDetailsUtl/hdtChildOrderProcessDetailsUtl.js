        ...
        this.fields = [
            ...
            },
            {
               ...
               data: [
                ...
                new fieldData('','Note__c', this.typeVisibility('acqua') && (this.order.RecordType.DeveloperName === 'HDT_RT_ConnessioneConAttivazione' || this.order.RecordType.DeveloperName === 'HDT_RT_Subentro' ), false, false, '',''),
                new fieldData('','SupplyCity__c', this.typeVisibility('acqua') && this.order.RecordType.DeveloperName === 'HDT_RT_Subentro', true, false, '',''),
                ...
                new fieldData('','ContractReference__c', this.typeVisibility('acqua') && this.order.RecordType.DeveloperName === 'HDT_RT_Subentro', false, true, '',''),

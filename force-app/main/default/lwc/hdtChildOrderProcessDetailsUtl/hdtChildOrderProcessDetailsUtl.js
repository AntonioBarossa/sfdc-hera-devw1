        ...
        this.fields = [
            {
                ...
                data:[
                    ...
                    new fieldData('Sottocategoria Ronchi','RonchiSubcategory__c', this.typeVisibility('both'), false, false,'',' '),
                    ...
                    new fieldData('Integrazione alla Dichiarazione (da Gestore)','IntegrationDeclarationManager__c', this.typeVisibility('both'), false, false,'',''),
                    ...
                    new fieldData('Integrazione alla Dichiarazione (da Contribuente)','IntegrationDeclarationTaxpayer__c', this.typeVisibility('both'), false, false,'',''),
                    new fieldData('Inizio periodo ravvedibile','RepentantPeriodStart__c', this.typeVisibility('both'), false, true,'',''),
                    new fieldData('Inizio periodo non ravvedibile','NonRepentantPeriodStart__c', this.typeVisibility('both'), false, true,'',''),
            ...
            },
            {
               ...
               data: [
                ...
                new fieldData('Potenzialità massima richiesta','MaxRequiredPotential__c', this.typeVisibility('both'), this.order.RecordType.DeveloperName === 'HDT_RT_Attivazione' && this.order.RecordType.DeveloperName === 'HDT_RT_Subentro', false, '',''),
            ...
            },
            {
                ...
                data: [
                    ...
                    new fieldData('Accise Agevolata Gas','ExciseGAS__c',this.typeVisibility('gas'),false,(this.order.RecordType.DeveloperName !== 'HDT_RT_CambioUso' && this.order.RecordType.DeveloperName !== 'HDT_RT_CambioOfferta'),''),

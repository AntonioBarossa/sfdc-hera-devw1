    ...
    export const AFUADRSdisable =  { evaluationType: 'visible', rateCategories: ['ACPROMISC0','ACPROMIBI0'] };
    ...
    export const NOTDOMESTICdisable =  { evaluationType: 'visible', rateCategories: ['ACPOZZI000','ACPROMISC0','ACPROMIBI0'] }; 
    ...
    export const AFUNACreq =  { evaluationType: 'required', rateCategories: ['ACARTCOMM0'] };

...
class Objectfields{
    constructor(appointmentCode,jobCenterCode,sotCode,startAppointment,endAppointment,phase,note,outcome){
        ...
        handleConfirm({
            ...
            if (!result){
                ...
                */
                ...
                this.case.StartAppointment__c = '2022-12-31';
                this.case.EndAppointment__c = '2022-12-31';
                this.case.Phase__c = 'Da Inviare';
                this.case.Outcome__c ='Recived_Slots';

                var caseFields = new Objectfields(this.case.AppointmentCode__c,this.case.JobCenterCode__c,this.case.SotCode__c,
                    this.formatData(this.case.StartAppointment__c),this.formatData(this.case.EndAppointment__c),this.case.Phase__c,null,this.case.Outcome__c);
